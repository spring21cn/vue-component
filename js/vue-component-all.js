  ...
  var TableContextMenu = {
    ...
    methods: {
      ...
      removeFilterColumn: function(column) {
        ...
        var i = this.filterList.indexOf(column);
        if(i >= 0) {
  ...
  var VueTable = {
    ...
    methods: {
      ...
      clearSorts: function() {
        ...
        self.$refs.contextMenu.sortList = [];
        VueUtil.loop(self.store.states.columns, function(column) {
          column.order = null;
        });
            ...
            if (column.property !== 'selectionColumn'
              ...
              && column.property !== 'expandColumn') {
                ...
                if (!field || field.indexOf('filter') > -1) {
                  setting.operations = column.operations;
                  setting.conditions = column.conditions;
                }
      ...
      setUserSetting: function(userSetting) {
        ...
        userSetting.columns.forEach(function(setting) {
          ...
          self.$refs.contextMenu.removeFilterColumn(column);
          ...
          if (setting.conditions && setting.operations) {
            self.$refs.contextMenu.filterForm = {
              filterColumn: column,
              conditions: setting.conditions,
              operations: setting.operations
            };
            self.$refs.contextMenu.filterColumn();
          }
